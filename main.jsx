...
function perceptionGames(){
  return [
    ...
    {id:'per-er12',code:'ER12',module:'Early Read',phase:'Functional Anticipation',title:'Read & Take High',category:'Perception',duration:8,format:'Front / Midcourt Read',rld:4,gate:'Before front wall',task:'P1 must commit early, then try to contact the ball above service-line height when appropriate.',scoring:'Early correct read = 1. Bonus if contact is above service-line height. Wrong-foot/no-commit recorded.',rationale:'Shows whether early pickup bought time and contact height, not just whether the player survived.',coach:'Use painted lines and clear height references. Avoid playerive “good shot” ratings.',playerFocus:'Use the read to take it higher.',layers:['Volley Finish','Opponent Information'],cbCode:'None'},
